...
/**
 * الإطلاق الجديد — جوار هايد بارك (ماونتن ڤيو، القاهرة الجديدة).
 * Placeholder identity until the project's official name is announced.
 */
export const content: ProjectContent = {
  slug: "hyde-park-launch",
  projectName: "الإطلاق الجديد — جوار هايد بارك",
  ...
  headline: "إطلاق جديد جوار هايد بارك — مقدم ٥٪ بس",
  subheadline:
    "أحدث مشاريع ماونتن ڤيو في القاهرة الجديدة. شقق تبدأ من ٨ مليون جنيه، آي ڤيلا من ١٣ مليون جنيه — مقدم ٥٪ فقط.",
  description:
    "فرصة محدودة قبل الإعلان الرسمي. مشروع جديد لماونتن ڤيو سور في سور مع كمبوند هايد بارك في القاهرة الجديدة، بنفس بنية الخدمات والمستوى المعروف عن MV.",
  ...
  whyPoints: [
    {
      ...
      description:
        "كمبوند هايد بارك من أكبر مشاريع ماونتن ڤيو في القاهرة الجديدة، والإطلاق الجديد سور في سور معاه — يعني نفس المنطقة بسعر إطلاق.",
    },
    {
  ...
  faqs: [
    {
      question: "إيه السعر اللي يبدأ منه الإطلاق الجديد؟",
      answer:
    ...
    },
    {
      ...
      answer:
        "لا، ده مشروع جديد لماونتن ڤيو سور في سور مع كمبوند هايد بارك في القاهرة الجديدة. نفس المنطقة، نفس مستوى الخدمات، لكنه إطلاق جديد بسعر بداية أقل.",
    },
    {
  ...
  seoTitle: "إطلاق ماونتن ڤيو الجديد | جوار هايد بارك — شقق من ٨ مليون",
  seoDescription:
    "أحدث إطلاقات ماونتن ڤيو في القاهرة الجديدة، سور في سور مع هايد بارك. شقق من ٨ مليون، آي ڤيلا من ١٣ مليون، مقدم ٥٪ فقط.",
  ogImage: "/projects/hyde-park-launch/cover.png",
  phoneNumber: "201223147238",
  whatsappNumber: "201118884994",
  whatsappInquiryMessage:
    "السلام عليكم، مهتم بالإطلاق الجديد لماونتن ڤيو جوار هايد بارك في القاهرة الجديدة وأرغب في التفاصيل قبل الإعلان الرسمي.",
  ctaText: "احجز قبل الإعلان",
  leadFormCtaText: "احجز قبل الإعلان الرسمي",
  offerBadge: "إطلاق جديد — مقدم ٥٪ فقط",
